<%-- 
    Document   : Profile
    Created on : 21-Aug-2022, 9:30:30 pm
    Author     : Ankush
--%>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><span class="fa fa-cogs"></span> Learn Code<span class="sr-only">(current)</span></a>
                    </li>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="list-group">
                            ...
                            <!--Categories-->
                            <%
                                PostDao dp = new PostDao(Connection_db.getConnection());
                                ArrayList<Category> list1 = dp.getAllCategorys();
